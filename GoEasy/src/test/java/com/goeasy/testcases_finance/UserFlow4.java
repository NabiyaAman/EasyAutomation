//=====================================================================================
//File:              GoEasy UserFlow 4
//Created:           2017/05/11
//Last Changed:      2017/06/04
//Author:            Nabiya and Venugopal reddy 
//Test case name:    User flow 4 for getting loan  
//=====================================================================================
//History:
//$Log:  
//Revision 
...
import com.goeasy.pageobjectlib.GetALoan;
	...
	public class UserFlow4 extends ExtentReport{
		/*============================================================================================================================
		 
		 Test Goal : Userflow 4, Get a loan->fill in the application(net pay<1200 weekly)->users get registered->complete application
		 ======================================================================================*/
	    ...
	    public void getLoan() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException{
					...
					//Create account
					//getLoan.AssertAutopopulatedEmailField();
					Thread.sleep(5000);
